...
ALTER TABLE [ConfigurationSettings]
ADD CONSTRAINT DF_SettingsCreatedDate DEFAULT getdate() FOR CreatedDate,
	CONSTRAINT DF_SettingsUpdatedDate DEFAULT getdate() FOR UpdatedDate;
